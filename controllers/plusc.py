...
def send_message():
    ...
    if form.process().accepted:
        ...
        message = client.sms.messages.create(to="+15167217331", from_="+15162047575", body=form.vars.f_body)
        #message = client.sms.messages.create(to=locNumber[0].f_sms_phone_number, from_="+15162047575", body=form.vars.f_body)
